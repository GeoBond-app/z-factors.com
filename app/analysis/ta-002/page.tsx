...
export const metadata = {
  title: 'Iran War Drives Global Inflation Surge, Unleashing Economic Pain Worldwide | Z-Factors',
  description: 'Energy prices skyrocket, adding 2 points to global inflation and sparking widespread economic instability.',
};

export default function TA002() {
  return (
    <main className="max-w-3xl mx-auto px-8 py-12 space-y-10">
      ...
      <header className="border-b border-neutral-200 pb-6">
        ...
        <div className="text-xs text-neutral-400 mt-3">
          Source: <a href="N/A" target="_blank" rel="noopener noreferrer" className="underline">WSJ / NYT / AP / Reuters</a>
        </div>
      </header>
      ...
      <section className="bg-neutral-50 rounded-lg p-5 space-y-2">
        ...
        <p className="text-sm text-neutral-600">Understand the true distribution of economic pain and strategic advantage in global conflicts. Advocate for policies that protect vulnerable populations during crises and question narratives that treat all economic burdens as equally shared.</p>
